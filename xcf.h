...
off_t xcf_level(FILE *xcf, FILE *psd, int w, int h, int channel_cnt, struct channel_info *xcf_chan[], int compr);
off_t xcf_hierarchy(FILE *xcf, FILE *psd, int w, int h, int channel_cnt, struct channel_info *xcf_chan[], int compr);
