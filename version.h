...
/* version history:
  ...
  05-Dec-2009: 3.1b2 various refactoring. fix segfault introduced in r284 (reported by Tobias Jakobs)
*/

#define VERSION_STR "3.1b2"  // <-- remember to change in configure.ac!
#define VERSION_NUM 3,0x10,beta,2
#define VERS_RSRC \
	VERSION_NUM,\
	verAustralia,\
	VERSION_STR,\
